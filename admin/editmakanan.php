<?php
	...
	include "../koneksi.php";
	$id = $_GET['id'];
	$data_edit = mysqli_query($conn, "SELECT * FROM db_makanan WHERE id = '".$id."'");
		...
		<div class="col-lg-12">
		    <div class="col-sm-9 col-md-7 col-lg-5 mx-auto" 
		    	style=" margin-top: 150px; background-image: url('Image/back.jpg');">
		    		<h3 style="font-size: 35px; font-weight: bold;color: white;">Edit Data Makanan</h3>
		    		<div id="myAlert" class="alert alert-success collapse">
						<a id="linkClose" href="" class="close">&times;</a>
						<strong>Daftar Makanan berhasil di rubah !!!</strong>
					</div>
					<div id="myAlert2" class="alert alert-danger collapse">
						<a id="linkClose" href="" class="close">&times;</a>
						<strong>Daftar Makanan gagal di rubah !!!</strong>
					</div>
		    		<form action="" method="post" enctype="multipart/form-data">
						<div class="form-group">
						    <label style="color: white;">Nama Makanan</label>
						    <input type="text" class="form-control" required name="makanan" value="<?php echo $row['makanan'] ?>" autocomplete="off" oninvalid="this.setCustomValidity('Wajib Masukan Nama Makanan')">
						</div>
					  	<div class="form-row">
					  	...
					  	<button type="submit" name="masuk" class="btn btn-success" style="width: 100%; margin-bottom: 20px;">Edit Makanan</button>
					  	<?php 
							if (isset($_POST['masuk'])) {
								$edit = mysqli_query ($conn, "UPDATE db_makanan SET  
