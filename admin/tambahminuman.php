...
<body>
		...
		<div class="col-lg-12">
			...
			<h3 style="font-size: 35px; font-weight: bold;color: white;">Tambah Daftar Minuman</h3>
		    <form action="" method="post" enctype="multipart/form-data">
			   	<div class="form-group">
					<label style="color: white;">Nama Minuman</label>
					<input type="text" class="form-control" required name="minuman" autocomplete="off" oninvalid="this.setCustomValidity('Wajib Masukan Nama Minuman')">
				</div>
				<div class="form-row">
				...
				<button type="submit" name="masuk" class="btn btn-success" style="width: 100%; margin-bottom: 20px;">Tambah Minuman</button>
						<?php
			                if(isset($_POST['masuk'])){
			                include "../koneksi.php";
			                $insert = mysqli_query($conn, "INSERT INTO db_minuman VALUES
			                    	(NULL, '".$_POST['minuman']."',
			                    		   '".$_POST['harga']."',
			                               '".$_POST['status']."')" );
			                    if ($insert) 
			                    ...
			                    else
			                    {
			                       echo '<script language="javascript">';
									echo 'alert("Gagal Menambahkan Data Minuman")';
									echo '</script>';
									echo  '<META HTTP-EQUIV="Refresh"; Content="0; URL=tambahminuman.php">';
			                    }
			                }
			            ?>
			</form>
